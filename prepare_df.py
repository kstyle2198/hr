...
회사정렬1 = ['HDX', 'HDI', 'HCE']
기준일자정렬1 = ['t20210801', 't20211001', 't20220101', 't20220401', 't20220701', 't20221001', 't20230101', 't20230401', 't20230801', 't20230901', 't20240101']#, 't20240401', 't20240801', 't20250101','t20250401', 't20250801', 't20260101']
고용형태정렬1 = ['직원']
사원유형정렬1 = ["사무기술직", "설계연구직"]
...
def location_df(df, companies, 기준일자):
    ...
    tdf["위도1"] = tdf["위도"].apply(살짝바꾸기)
    tdf["경도1"] = tdf["경도"].apply(살짝바꾸기)
    tdf = tdf.rename(columns = {"임시키": "인원", "위도1": "lat", "경도1": "lon"})
