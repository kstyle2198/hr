...
with col02:
    ...
    with col1001:
        select001 =st.multiselect('🏢 **회사 선택**', ['HG', 'HDI', 'HCE', 'HCM'], ['HG'], key="회사0")
    with col1002:
    ...
    col1.metric("**임원**", f"{임원1} 명", f"{임원변동} 명")
    col2.metric("**설계연구직**", f"{설계연구직1} 명", f"{설계연구변동} 명")
    col3.metric("**사무기술직**", f"{사무기술직1} 명", f"{사무기술변동} 명")
    col4.metric("**전문직A**", f"{전문직A1} 명", f"{전문직A변동} 명")
    col5.metric("**사무지원/전문직B**", f"{사무지원전문직B1} 명", f"{사무지원전문직B변동} 명")
    col6.metric("**생산직/별정직**", f"{생산별정직1} 명", f"{생산별정직변동} 명")
    col7.metric("**총원**", f"{총원1} 명", f"{총원변동} 명")
